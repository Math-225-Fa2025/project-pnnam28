...
\begin{verbatim}
## # A tibble: 3 x 4
##   sleep_disorder     n mean_quality sd_quality
##   <fct>          <int>        <dbl>      <dbl>
## 1 Insomnia          77         6.53      0.804
## 2 None             219         7.63      0.975
## 3 Sleep Apnea       78         7.21      1.65
\end{verbatim}
...
\begin{center}\includegraphics{Project_files/figure-latex/unnamed-chunk-5-1} \end{center}
